...
abstract class BaseUsersPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Login', 'Password', 'Role', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'login', 'password', 'role', ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID, UsersPeer::LOGIN, UsersPeer::PASSWORD, UsersPeer::ROLE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOGIN', 'PASSWORD', 'ROLE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'login', 'password', 'role', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Login' => 1, 'Password' => 2, 'Role' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'login' => 1, 'password' => 2, 'role' => 3, ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID => 0, UsersPeer::LOGIN => 1, UsersPeer::PASSWORD => 2, UsersPeer::ROLE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LOGIN' => 1, 'PASSWORD' => 2, 'ROLE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'login' => 1, 'password' => 2, 'role' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersPeer::ROLE);
        } else {
