 ...
 */
abstract class BaseMatches extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'MatchesPeer';
    ...
    /**
     * The value for the team1 field.
     * @var        string
     */
    protected $team1;

    /**
     * The value for the team2 field.
     * @var        string
     */
    protected $team2;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MatchesPeer::ID;
        }
    ...
    /**
     * Set the value of [team1] column.
     *
     * @param  string $v new value
     * @return Matches The current object (for fluent API support)
     */
    public function setTeam1($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->team1 !== $v) {
            $this->team1 = $v;
            $this->modifiedColumns[] = MatchesPeer::TEAM1;
        }
    ...
    /**
     * Set the value of [team2] column.
     *
     * @param  string $v new value
     * @return Matches The current object (for fluent API support)
     */
    public function setTeam2($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->team2 !== $v) {
            $this->team2 = $v;
            $this->modifiedColumns[] = MatchesPeer::TEAM2;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MatchesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MatchesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MatchesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MatchesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MatchesPeer::TEAM1)) {
            $modifiedColumns[':p' . $index++]  = '`team1`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`team1`':
                        $stmt->bindValue($identifier, $this->team1, PDO::PARAM_STR);
                        break;
                    case '`team2`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MatchesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MatchesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Matches'][$this->getPrimaryKey()] = true;
        $keys = MatchesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(MatchesPeer::DATABASE_NAME);
        $criteria->add(MatchesPeer::ID, $this->id);
    ...
    {
        return (string) $this->exportTo(MatchesPeer::DEFAULT_STRING_FORMAT);
    }
